...
Scence.prototype.initDino = function() {
  ...
  this.contain()
  let {hit,collision} = this.hitWallReact(this.Dino, this.rect)
  this.Dino.isHit = hit
...
Scence.prototype.moveViewportXBy = function(units) {
  ...
  if(newViewportX&&newViewportX%100 == 0) {
    for(let i = 0; i < 5; i++) {
      let coin = new Coin()
      coin.setPosition(512 + i*20,100)
      this.Coins.push(coin)
...
Scence.prototype.hitWallReact = function(r1, r2) {
...
Scence.prototype.hitCoin = function(r1, r2) {
